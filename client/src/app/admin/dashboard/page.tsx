          ...
          <Link href="/admin/users">
            <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition cursor-pointer">
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-sm text-indigo-600">Ver todos →</span>
              </div>
            </div>
          </Link>
          ...
          <Link href="/admin/plans">
            <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition cursor-pointer">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-green-600">Ver todos →</span>
              </div>
            </div>
          </Link>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Atividades nos Planos</p>
              </div>
            </div>
          </div>
          ...
          <Link href="/admin/reports">
            <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition cursor-pointer">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-cyan-600">Ver todos →</span>
              </div>
            </div>
          </Link>
        </div>
